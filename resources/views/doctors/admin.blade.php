...
<body>
    ...
    <body class="login-page">
        ...
        <div id="dashboardSection" class="dashboard-section" style="display: block;">
                                ...
                                <form id="profileForm">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="profileKTP"
                                                value="3201011234560001" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Tanggal Lahir</label>
                    ...
                    <div class="modal-body">
                        <form id="newsForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Pilih gambar untuk berita (maks. 2MB)</div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editInstagramPostModalLabel">
                            <i class="fas fa-edit me-2"></i>Edit Postingan Instagram
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="editInstagramPostForm">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="editPostImage" class="form-label">Ganti Foto (Opsional)</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control" id="editPostLink" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="editPostCaption" class="form-label">Caption</label>
                                        <textarea class="form-control" id="editPostCaption" rows="5"
                                            required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div id="editImagePreview" style="display: none;">
                                    <img id="editPreviewImg" src="" alt="Preview" class="img-fluid rounded mb-2">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editProfileModalLabel">
                                <i class="fas fa-user-edit me-2"></i>Edit Profil Dokter
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="editTitle" class="form-label">Gelar</label>
                                            <input type="text" class="form-control" id="editTitle" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="editSpecialty" class="form-label">Spesialisasi</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="editEducation" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="editExperience" class="form-label">Pengalaman</label>
                                            <input type="text" class="form-control" id="editExperience" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="editSchedule" class="form-label">Jadwal Praktik</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="currentImageInfo" class="form-text"></div>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn book-btn" id="saveChangesBtn">
                                <i class="fas fa-save me-2"></i>Simpan Perubahan
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    ...
                                    <div class="doctor-contact-info mt-4">
                                        <p class="mb-1"><i class="fas fa-user-md me-2"></i> <span
                                                id="modalTitle"></span>
                                        </p>
                                        ...
                                        <p class="mb-1"><i class="fas fa-phone-alt me-2"></i> <span
                                                id="modalPhone"></span>
                                        </p>
                                        <p class="mb-0"><i class="fas fa-envelope me-2"></i> <span
                                                id="modalEmail"></span>
                                        </p>
                                    </div>
                                </div>
