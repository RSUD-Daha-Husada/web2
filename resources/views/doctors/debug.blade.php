        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/doctors') }}">Tim Dokter</a>
                    </li>
                    <li class="nav-item">
                ...
                <a href="{{ url('/patient-portal') }}" class="btn btn-primary ms-3">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row g-4" id="doctorContainer">
                ...
                <div class="col-lg-3 col-md-6 doctor-card" data-specialty="{{ strtolower(str_replace(' ', '-', $doctor->specialty)) }}">
                    <div class="card h-100">
                        <div class="position-relative">
                            @if($doctor->image)
                                <img src="{{ asset($doctor->image) }}" class="card-img-top doctor-img" alt="{{ $doctor->name }}">
                            @else
                                <img src="https://picsum.photos/seed/doctor{{ $doctor->id }}/400/400.jpg" class="card-img-top doctor-img" alt="{{ $doctor->name }}">
                            @endif
                            <span class="badge specialty-badge">{{ $doctor->title }}</span>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2 mt-3">
                                <button class="btn-profile" onclick="showDoctorProfile({{ $doctor->id }})">
    ...
    <script>
        ...
        let doctors = [
            @foreach($doctors as $doctor)
            {
                id: {{ $doctor->id }},
                name: "{{ $doctor->name }}",
                specialty: "{{ strtolower(str_replace(' ', '-', $doctor->specialty)) }}",
                title: "{{ $doctor->title }}",
